...
namespace Lab2_4VarSyntaxConsoleApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // 16.Use Console.WriteLine to print the text "Breakpoint Here".Insert a breakpoinnt to pause execution at this line.
            // and inspect the values of all of your variables. Hover your mouse over the variable to see its value appear.
            ...
            // 18. Create a variable call results as an integer and assign it the value of 99 * textToNumber. Use int.Parse() to complete the operation. Print the results.
